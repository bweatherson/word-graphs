...
ui <- navbarPage("Word Usage in Philosophy Journals",
           ...
           "10+ Appearances" = "topic"),
                                           selected = "frequency"),
                              textInput("word", "Enter a word:", value = "the")
                            ),
                            mainPanel(
                          ...
                          fluidRow(
                            column(10, offset = 1,
                                   ...
                                   tags$ul(
                                     ...
                                     tags$li("Appear at least 2000 times across all journals"),
  ...
  output$usagePlot <- renderPlot({
    ...
    if (nrow(data) == 0) {
      ...
      ggplot(data, aes(x = year, y = value)) +
        ...
        labs(title = paste("Usage of", input$word), y = y_label, x = element_blank()) +
        theme_minimal() +
        theme(
